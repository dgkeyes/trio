...
Of the 59 participants registered for the training, 45 completed the pre survey (a 76% response rate) and 42 completed the post survey (a 71% response rate). 
...
Fifty-nine participants were involved with the March training. The locations of the institutions they represent are below. Click on any point to see the name of the institution. 
